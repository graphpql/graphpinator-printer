...
final class HtmlPrinterTest extends \PHPUnit\Framework\TestCase
{
        ...
        return [
            ...
            [
                ...
                <section id="graphql-type-__TypeKind">
                    <div class="description">
                    <div class="line">"""</div>
                    <div class="line">Built-in introspection enum.</div>
                    <div class="line">"""</div>
                </div>
                    <div class="line">
            ...
            [
                ...
                <div class="floating-container">
                    ...
                    <a href="#graphql-type-Query" class="floating-button" title="Go to query root type">Q</a>
            ...
            [
                ...
                <div class="floating-container">
                    <a href="#graphpinator-schema" class="floating-button" title="Go to top">&uarr;</a>
                    <a href="#graphql-type-Query" class="floating-button" title="Go to query root type">Q</a>
                    <a href="#graphql-type-Query" class="floating-button" title="Go to mutation root type">M</a>
                    <a href="#graphql-type-Query" class="floating-button" title="Go to subscription root type">S</a>
                </div>
                <section id="graphql-schema">
                    <div class="description">
                    <div class="line">"""</div>
    ...
    {
        $expected = <<<'EOL'
        <div class="graphpinator-schema" id="graphpinator-schema"><div class="code"><div class="floating-container"><a href="#graphpinator-schema" class="floating-button" title="Go to top">&uarr;</a><a href="#graphql-type-Query" class="floating-button" title="Go to query root type">Q</a></div><section id="graphql-schema"><div class="line"><span class="keyword">schema</span>&nbsp;<span class="bracket-curly">{</span></div><div class="offset"><div class="line"><span class="field-name">query</span><span class="colon">:</span>&nbsp;<span class="field-type"><a class="typename" href="#graphql-type-Query" title="">Query</a></span></div><div class="line"><span class="field-name">mutation</span><span class="colon">:</span>&nbsp;<span class="null">null</span></div><div class="line"><span class="field-name">subscription</span><span class="colon">:</span>&nbsp;<span class="null">null</span></div></div><div class="line"><span class="bracket-curly">}</span></div></section><div class="line">&nbsp;</div><section id="graphql-type-ChildInterface"><div class="line"><span class="keyword">interface</span>&nbsp;<span class="typename">ChildInterface</span>&nbsp;<span class="keyword">implements</span>&nbsp;<a class="typename" href="#graphql-type-ParentInterface" title="ParentInterface Description">ParentInterface</a>&nbsp;<span class="bracket-curly">{</span></div><div class="offset"><div class="line"><span class="field-name">name</span><span class="colon">:</span>&nbsp;<span class="field-type"><a class="typename"  title="String built-in type">String</a><span class="exclamation-mark">!</span></span></div><div class="line"><span class="field-name">number</span><span class="colon">:</span>&nbsp;<span class="field-type"><a class="typename"  title="Int built-in type (32 bit)">Int</a><span class="exclamation-mark">!</span></span></div></div><div class="line"><span class="bracket-curly">}</span></div></section><div class="line">&nbsp;</div><section id="graphql-type-ChildType"><div class="line"><span class="keyword">type</span>&nbsp;<span class="typename">ChildType</span>&nbsp;<span class="keyword">implements</span>&nbsp;<a class="typename" href="#graphql-type-ParentInterface" title="ParentInterface Description">ParentInterface</a>&nbsp;<span class="ampersand">&</span>&nbsp;<a class="typename" href="#graphql-type-ChildInterface" title="">ChildInterface</a>&nbsp;<span class="ampersand">&</span>&nbsp;<a class="typename" href="#graphql-type-SecondInterface" title="">SecondInterface</a>&nbsp;<span class="bracket-curly">{</span></div><div class="offset"><div class="line"><span class="field-name">name</span><span class="colon">:</span>&nbsp;<span class="field-type"><a class="typename"  title="String built-in type">String</a><span class="exclamation-mark">!</span></span></div><div class="line"><span class="field-name">number</span><span class="colon">:</span>&nbsp;<span class="field-type"><a class="typename"  title="Int built-in type (32 bit)">Int</a><span class="exclamation-mark">!</span></span></div><div class="line"><span class="field-name">secondField</span><span class="colon">:</span>&nbsp;<span class="field-type"><a class="typename"  title="String built-in type">String</a><span class="exclamation-mark">!</span></span></div></div><div class="line"><span class="bracket-curly">}</span></div></section><div class="line">&nbsp;</div><section id="graphql-type-ComplexDefaultsInput"><div class="description"><div class="line">"""</div><div class="line">ComplexDefaultsInput description</div><div class="line">"""</div></div><div class="line"><span class="keyword">input</span>&nbsp;<span class="typename">ComplexDefaultsInput</span>&nbsp;<span class="bracket-curly">{</span></div><div class="offset"><div class="line"><span class="argument-name">name</span><span class="colon">:</span>&nbsp;<span class="argument-type"><a class="typename"  title="String built-in type">String</a></span>&nbsp;<span class="equals">=</span>&nbsp;<span class="argument-value"><span class="string-literal">"default"</span></span></div><div class="line"><span class="argument-name">inner</span><span class="colon">:</span>&nbsp;<span class="argument-type"><a class="typename" href="#graphql-type-ComplexDefaultsInput" title="ComplexDefaultsInput description">ComplexDefaultsInput</a></span>&nbsp;<span class="equals">=</span>&nbsp;<span class="argument-value"><span class="bracket-curly">{</span><span class="value"><span class="value-name">name</span><span class="colon">:</span><span class="string-literal">"innerDefault"</span><span class="comma">,</span><span class="value-name">inner</span><span class="colon">:</span><span class="bracket-curly">{</span><span class="value"><span class="value-name">name</span><span class="colon">:</span><span class="string-literal">"innerInnerDefault"</span><span class="comma">,</span><span class="value-name">inner</span><span class="colon">:</span><span class="null">null</span><span class="comma">,</span><span class="value-name">innerList</span><span class="colon">:</span><span class="bracket-square">[</span><span class="bracket-square">]</span></span><span class="bracket-curly">}</span></span><span class="bracket-curly">}</span></span></div><div class="line"><span class="argument-name">innerList</span><span class="colon">:</span>&nbsp;<span class="argument-type"><span class="bracket-square">[</span><a class="typename" href="#graphql-type-ComplexDefaultsInput" title="ComplexDefaultsInput description">ComplexDefaultsInput</a><span class="bracket-square">]</span></span>&nbsp;<span class="equals">=</span>&nbsp;<span class="argument-value"><span class="bracket-square">[</span><span class="value"><span class="bracket-curly">{</span><span class="value"><span class="value-name">name</span><span class="colon">:</span><span class="string-literal">"innerList1"</span><span class="comma">,</span><span class="value-name">inner</span><span class="colon">:</span><span class="bracket-curly">{</span><span class="value"><span class="value-name">name</span><span class="colon">:</span><span class="string-literal">"innerDefault"</span><span class="comma">,</span><span class="value-name">inner</span><span class="colon">:</span><span class="bracket-curly">{</span><span class="value"><span class="value-name">name</span><span class="colon">:</span><span class="string-literal">"innerInnerDefault"</span><span class="comma">,</span><span class="value-name">inner</span><span class="colon">:</span><span class="null">null</span><span class="comma">,</span><span class="value-name">innerList</span><span class="colon">:</span><span class="bracket-square">[</span><span class="bracket-square">]</span></span><span class="bracket-curly">}</span></span><span class="bracket-curly">}</span><span class="comma">,</span><span class="value-name">innerList</span><span class="colon">:</span><span class="bracket-square">[</span><span class="value"><span class="bracket-curly">{</span><span class="value"><span class="value-name">name</span><span class="colon">:</span><span class="string-literal">"string"</span><span class="comma">,</span><span class="value-name">inner</span><span class="colon">:</span><span class="bracket-curly">{</span><span class="value"><span class="value-name">name</span><span class="colon">:</span><span class="string-literal">"innerDefault"</span><span class="comma">,</span><span class="value-name">inner</span><span class="colon">:</span><span class="bracket-curly">{</span><span class="value"><span class="value-name">name</span><span class="colon">:</span><span class="string-literal">"innerInnerDefault"</span><span class="comma">,</span><span class="value-name">inner</span><span class="colon">:</span><span class="null">null</span><span class="comma">,</span><span class="value-name">innerList</span><span class="colon">:</span><span class="bracket-square">[</span><span class="bracket-square">]</span></span><span class="bracket-curly">}</span></span><span class="bracket-curly">}</span><span class="comma">,</span><span class="value-name">innerList</span><span class="colon">:</span><span class="null">null</span></span><span class="bracket-curly">}</span><span class="comma">,</span><span class="bracket-curly">{</span><span class="value"><span class="value-name">name</span><span class="colon">:</span><span class="string-literal">"string"</span><span class="comma">,</span><span class="value-name">inner</span><span class="colon">:</span><span class="bracket-curly">{</span><span class="value"><span class="value-name">name</span><span class="colon">:</span><span class="string-literal">"innerDefault"</span><span class="comma">,</span><span class="value-name">inner</span><span class="colon">:</span><span class="bracket-curly">{</span><span class="value"><span class="value-name">name</span><span class="colon">:</span><span class="string-literal">"innerInnerDefault"</span><span class="comma">,</span><span class="value-name">inner</span><span class="colon">:</span><span class="null">null</span><span class="comma">,</span><span class="value-name">innerList</span><span class="colon">:</span><span class="bracket-square">[</span><span class="bracket-square">]</span></span><span class="bracket-curly">}</span></span><span class="bracket-curly">}</span><span class="comma">,</span><span class="value-name">innerList</span><span class="colon">:</span><span class="null">null</span></span><span class="bracket-curly">}</span></span><span class="bracket-square">]</span></span><span class="bracket-curly">}</span><span class="comma">,</span><span class="bracket-curly">{</span><span class="value"><span class="value-name">name</span><span class="colon">:</span><span class="string-literal">"innerList2"</span><span class="comma">,</span><span class="value-name">inner</span><span class="colon">:</span><span class="bracket-curly">{</span><span class="value"><span class="value-name">name</span><span class="colon">:</span><span class="string-literal">"innerDefault"</span><span class="comma">,</span><span class="value-name">inner</span><span class="colon">:</span><span class="bracket-curly">{</span><span class="value"><span class="value-name">name</span><span class="colon">:</span><span class="string-literal">"innerInnerDefault"</span><span class="comma">,</span><span class="value-name">inner</span><span class="colon">:</span><span class="null">null</span><span class="comma">,</span><span class="value-name">innerList</span><span class="colon">:</span><span class="bracket-square">[</span><span class="bracket-square">]</span></span><span class="bracket-curly">}</span></span><span class="bracket-curly">}</span><span class="comma">,</span><span class="value-name">innerList</span><span class="colon">:</span><span class="bracket-square">[</span><span class="value"><span class="bracket-curly">{</span><span class="value"><span class="value-name">name</span><span class="colon">:</span><span class="string-literal">"string2"</span><span class="comma">,</span><span class="value-name">inner</span><span class="colon">:</span><span class="bracket-curly">{</span><span class="value"><span class="value-name">name</span><span class="colon">:</span><span class="string-literal">"innerDefault"</span><span class="comma">,</span><span class="value-name">inner</span><span class="colon">:</span><span class="bracket-curly">{</span><span class="value"><span class="value-name">name</span><span class="colon">:</span><span class="string-literal">"innerInnerDefault"</span><span class="comma">,</span><span class="value-name">inner</span><span class="colon">:</span><span class="null">null</span><span class="comma">,</span><span class="value-name">innerList</span><span class="colon">:</span><span class="bracket-square">[</span><span class="bracket-square">]</span></span><span class="bracket-curly">}</span></span><span class="bracket-curly">}</span><span class="comma">,</span><span class="value-name">innerList</span><span class="colon">:</span><span class="null">null</span></span><span class="bracket-curly">}</span><span class="comma">,</span><span class="bracket-curly">{</span><span class="value"><span class="value-name">name</span><span class="colon">:</span><span class="string-literal">"string2"</span><span class="comma">,</span><span class="value-name">inner</span><span class="colon">:</span><span class="bracket-curly">{</span><span class="value"><span class="value-name">name</span><span class="colon">:</span><span class="string-literal">"innerDefault"</span><span class="comma">,</span><span class="value-name">inner</span><span class="colon">:</span><span class="bracket-curly">{</span><span class="value"><span class="value-name">name</span><span class="colon">:</span><span class="string-literal">"innerInnerDefault"</span><span class="comma">,</span><span class="value-name">inner</span><span class="colon">:</span><span class="null">null</span><span class="comma">,</span><span class="value-name">innerList</span><span class="colon">:</span><span class="bracket-square">[</span><span class="bracket-square">]</span></span><span class="bracket-curly">}</span></span><span class="bracket-curly">}</span><span class="comma">,</span><span class="value-name">innerList</span><span class="colon">:</span><span class="null">null</span></span><span class="bracket-curly">}</span></span><span class="bracket-square">]</span></span><span class="bracket-curly">}</span></span><span class="bracket-square">]</span></span></div></div><div class="line"><span class="bracket-curly">}</span></div></section><div class="line">&nbsp;</div><section id="graphql-type-DescriptionEnum"><div class="line"><span class="keyword">enum</span>&nbsp;<span class="typename">DescriptionEnum</span>&nbsp;<span class="bracket-curly">{</span></div><div class="offset"><div class="description"><div class="line">"single line description"</div></div><div class="line enum-item">A</div><div class="line">&nbsp;</div><div class="line enum-item">B&nbsp;<span class="typename"><a class="typename"  title="Built-in deprecated directive.">@deprecated</a></span></div><div class="line">&nbsp;</div><div class="description"><div class="line">"""</div><div class="line">multi line</div><div class="line">description</div><div class="line">"""</div></div><div class="line enum-item">C</div><div class="line">&nbsp;</div><div class="description"><div class="line">"single line description"</div></div><div class="line enum-item">D&nbsp;<span class="typename"><a class="typename"  title="Built-in deprecated directive.">@deprecated</a></span><span class="bracket-round">(</span><span class="argument-name">reason</span><span class="colon">:</span>&nbsp;<span class="argument-value"><span class="string-literal">"reason"</span></span><span class="bracket-round">)</span></div></div><div class="line"><span class="bracket-curly">}</span></div></section><div class="line">&nbsp;</div><section id="graphql-type-ParentInterface"><div class="description"><div class="line">"""</div><div class="line">ParentInterface Description</div><div class="line">"""</div></div><div class="line"><span class="keyword">interface</span>&nbsp;<span class="typename">ParentInterface</span>&nbsp;<span class="bracket-curly">{</span></div><div class="offset"><div class="line"><span class="field-name">name</span><span class="colon">:</span>&nbsp;<span class="field-type"><a class="typename"  title="String built-in type">String</a><span class="exclamation-mark">!</span></span></div></div><div class="line"><span class="bracket-curly">}</span></div></section><div class="line">&nbsp;</div><section id="graphql-type-Query"><div class="line"><span class="keyword">type</span>&nbsp;<span class="typename">Query</span>&nbsp;<span class="bracket-curly">{</span></div><div class="offset"><div class="line"><span class="field-name">field1</span><span class="colon">:</span>&nbsp;<span class="field-type"><a class="typename"  title="String built-in type">String</a></span></div><div class="line">&nbsp;</div><div class="description"><div class="line">"Description to field"</div></div><div class="line"><span class="field-name">fieldWithDescription</span><span class="colon">:</span>&nbsp;<span class="field-type"><a class="typename"  title="String built-in type">String</a></span></div><div class="line">&nbsp;</div><div class="line"><span class="field-name">field2</span><span class="colon">:</span>&nbsp;<span class="field-type"><a class="typename"  title="String built-in type">String</a></span></div></div><div class="line"><span class="bracket-curly">}</span></div></section><div class="line">&nbsp;</div><section id="graphql-type-SecondInterface"><div class="line"><span class="keyword">interface</span>&nbsp;<span class="typename">SecondInterface</span>&nbsp;<span class="bracket-curly">{</span></div><div class="offset"><div class="line"><span class="field-name">secondField</span><span class="colon">:</span>&nbsp;<span class="field-type"><a class="typename"  title="String built-in type">String</a><span class="exclamation-mark">!</span></span></div></div><div class="line"><span class="bracket-curly">}</span></div></section><div class="line">&nbsp;</div><section id="graphql-type-SimpleEnum"><div class="line"><span class="keyword">enum</span>&nbsp;<span class="typename">SimpleEnum</span>&nbsp;<span class="bracket-curly">{</span></div><div class="offset"><div class="line enum-item">A</div><div class="line enum-item">B</div><div class="line enum-item">C</div><div class="line enum-item">D</div></div><div class="line"><span class="bracket-curly">}</span></div></section><div class="line">&nbsp;</div><section id="graphql-type-SimpleInput"><div class="line"><span class="keyword">input</span>&nbsp;<span class="typename">SimpleInput</span>&nbsp;<span class="bracket-curly">{</span></div><div class="offset"><div class="line"><span class="argument-name">name</span><span class="colon">:</span>&nbsp;<span class="argument-type"><a class="typename"  title="String built-in type">String</a><span class="exclamation-mark">!</span></span></div><div class="line"><span class="argument-name">number</span><span class="colon">:</span>&nbsp;<span class="argument-type"><span class="bracket-square">[</span><a class="typename"  title="Int built-in type (32 bit)">Int</a><span class="exclamation-mark">!</span><span class="bracket-square">]</span><span class="exclamation-mark">!</span></span></div><div class="line"><span class="argument-name">bool</span><span class="colon">:</span>&nbsp;<span class="argument-type"><a class="typename"  title="Boolean built-in type">Boolean</a></span></div></div><div class="line"><span class="bracket-curly">}</span></div></section><div class="line">&nbsp;</div><section id="graphql-type-SimpleScalar"><div class="line"><span class="keyword">scalar</span>&nbsp;<span class="typename">SimpleScalar</span></div></section><div class="line">&nbsp;</div><section id="graphql-type-SimpleType"><div class="description"><div class="line">"""</div><div class="line">Description for SimpleType</div><div class="line">"""</div></div><div class="line"><span class="keyword">type</span>&nbsp;<span class="typename">SimpleType</span>&nbsp;<span class="bracket-curly">{</span></div><div class="offset"><div class="line"><span class="field-name">name</span><span class="colon">:</span>&nbsp;<span class="field-type"><a class="typename"  title="String built-in type">String</a><span class="exclamation-mark">!</span></span></div></div><div class="line"><span class="bracket-curly">}</span></div></section><div class="line">&nbsp;</div><section id="graphql-type-SimpleUnion"><div class="line"><span class="keyword">union</span>&nbsp;<span class="typename">SimpleUnion&nbsp;<span class="equals">=</span>&nbsp;<span class="union-type"><a class="typename" href="#graphql-type-SimpleType" title="Description for SimpleType">SimpleType</a></span>&nbsp;<span class="vertical-line">|</span>&nbsp;<span class="union-type"><a class="typename" href="#graphql-type-ChildType" title="">ChildType</a></span></span></div></section><div class="line">&nbsp;</div><section id="graphql-directive-simpleDirective"><div class="line"><span class="keyword">directive</span>&nbsp;<span class="typename">@simpleDirective</span><span class="bracket-round">(</span></div><div class="offset"><div class="line"><span class="argument-name">reason</span><span class="colon">:</span>&nbsp;<span class="argument-type"><a class="typename"  title="String built-in type">String</a></span></div></div><div class="line"><span class="bracket-round">)</span>&nbsp;<span class="keyword">repeatable</span>&nbsp;<span class="keyword">on</span>&nbsp;<span class="enum-literal">FIELD</span>&nbsp;<span class="vertical-line">|</span>&nbsp;<span class="enum-literal">INLINE_FRAGMENT</span>&nbsp;<span class="vertical-line">|</span>&nbsp;<span class="enum-literal">FRAGMENT_SPREAD</span></div></section></div></div>
        EOL;
